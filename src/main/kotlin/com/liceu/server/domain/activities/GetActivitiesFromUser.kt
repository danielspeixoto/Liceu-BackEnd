...
class GetActivitiesFromUser(
    ...
    override fun run(userId: String, amount: Int, tags: List<String>, start: Int): List<Activity> {
        if(amount == 0) {
        ...
        try {
            ...
            return activityRepository.getActivitiesFromUser(userId,finalAmount,tags,start)
        }catch (e: Exception){
